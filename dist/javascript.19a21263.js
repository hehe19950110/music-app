  ...
  _createClass(Player, [{
    ...
    value: function bind() {
      ...
      swiper.on('swipLeft', function () {
        _this3.root.querySelector('.panels').classList.remove('panel1');

        _this3.root.querySelector('.panels').classList.add('panel2');
      });
      swiper.on('swipRight', function () {
        _this3.root.querySelector('.panels').classList.remove('panel2');

        _this3.root.querySelector('.panels').classList.add('panel1');
      });
    ...
    value: function renderSong() {
      ...
      this.audio.onloadedmetadata = function () {
        return _this4.root.querySelector('.time-end').innerText = _this4.formateTime(_this4.audio.duration);
      };
    ...
    value: function loadLyrics() {
      ...
      fetch(this.songList[this.currentIndex].lyric).then(function (res) {
        ...
        _this8.setLyrics(data.lrc.lyric);

        _this8.lyrics = data.lrc.lyric;
    ...
    value: function setLyricToCenter(node) {
      var translateY = node.offsetTop - this.root.querySelector('.panel-lyrics').offsetHeight / 2;
      translateY = translateY > 0 ? translateY : 0;
      this.root.querySelector('.panel-lyrics .container').style.transform = "translateY(-".concat(translateY, "px)");
      this.root.querySelectorAll('.panel-lyrics p').forEach(function (node) {
